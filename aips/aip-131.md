...
Under consensus backpressure, the leader should not propose optimistic blocks. Since the proposal will be delayed under the backpressure (for gas priority under high load), having optismistic proposal will likely result in two rounds of timeout due to `ProposalNotReceived`.
