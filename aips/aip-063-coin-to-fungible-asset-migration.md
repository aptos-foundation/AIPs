...
## Summary
[AIP-21](https://github.com/lightmark/AIPs/blob/main/aips/aip-021-fungible-assets.md) introduced fungible asset (FA) standard aiming to replace the old coin standard to represent any fungible asset on chain, including but not limited to coin.
