...
Public blockchains provide strong transparency guarantees but expose sensitive financial information. On most blockchains today, transaction amounts and account balances are publicly visible, which can introduce several challenges.
...
Third, confidentiality can improve regulatory compatibility. Confidential transactions can support selective disclosure mechanisms that allow authorized auditors or regulators to inspect transactions while preserving privacy for the broader public.
...
Hiding balances and transfer amounts protects users from financial surveillance and enables institutional adoption. At the same time, keeping sender and recipient addresses visible preserves a level of transparency necessary to prevent abuse and maintain network trust.
...
This ensures that the system launches without default surveillance while preserving the option for regulated or institutional use cases that may require auditability.
...
- Preserving user trust at launch by avoiding default surveillance
- Removing risks associated with centralized auditor key custody
- Allowing auditing capability if required for regulatory environments
...
- Ensuring that privacy-driven utility accrues directly to APT
...
The introduction of Confidential APT expands the design space for applications built on Aptos by enabling privacy-preserving financial interactions while maintaining verifiability at the protocol level.
...
The governance-controlled auditing capability provides a mechanism for supporting compliance requirements without introducing default surveillance.

## Long-Term Ecosystem Evolution

By introducing confidential balances as a core primitive, Aptos positions itself to support privacy-aware financial infrastructure as the ecosystem evolves.
...
Future iterations may introduce stronger privacy guarantees through invisible transfers, where transaction amounts and potentially sender or recipient identities are hidden.

Such features would require extensive security review and governance approval before deployment.

See the research work here: [https://docs.google.com/presentation/d/1gROYWWXabwqbxFVGLV4KKOMuQbmvoGjqo502I0W6W7Q/edit?slide=id.g277ae8ab1df_0_0#slide=id.g277ae8ab1df_0_0](https://docs.google.com/presentation/d/1gROYWWXabwqbxFVGLV4KKOMuQbmvoGjqo502I0W6W7Q/edit?slide=id.g277ae8ab1df_0_0#slide=id.g277ae8ab1df_0_0)
