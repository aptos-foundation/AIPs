...
Safe burn was originally described in [AIP-45](./aip-045-safe-burning-of-user-owned-objects.md), which allowed users to tombstone their objects and remove
direct linkage of an undeletable, also known as *soulbound*, object to an account. [AIP-99](./aip-099-disable-object-burn.md) that 
...
The previous [AIP-45](./aip-045-safe-burning-of-user-owned-objects.md) captured the main risks of having the AIP, including having unwanted *soulbound*
