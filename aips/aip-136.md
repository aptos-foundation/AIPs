...
Given how CRQCs timelines range anywhere from 5 to 50 years[^uncertainity], this AIP's _"conservative"_ approach means:
...
```
 ...
 > [!NOTE]
 > For more PQ signature schemes bechmarks see (1) this public GitHub repo by Project 11[^benching-pq] and (2) this PQC Suite B README[^pqc-suite-b-benches].
...
### Q1: Should we use hedged (randomized) signing or deterministic signing (currently-enabled)?
