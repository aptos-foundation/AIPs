...
This AIP describes the changes in the transaction format. [AIP 123](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-123-orderless-transactions.md) describes the structure of the nonce table and how the replay protection is done.
