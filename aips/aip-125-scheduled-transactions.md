...
Depends on [AIP-112](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-112-function-values-the-move-vm.md) (Function Values in the Move VM), FA migration.
...
#### Gas prioritization
The user transactions are shuffled by a use-case aware shuffler ([AIP- 68](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-068-use-case-aware-block-reordering.md)). We then insert scheduled transactions into appropriate positions within this reordered sequence, determined by their gas priority.  
