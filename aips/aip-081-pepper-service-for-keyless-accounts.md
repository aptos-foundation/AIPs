...
In [keyless accounts](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-061-keyless-accounts.md) an end user needs a private blinding factor (pepper) as an input in the privacy-preserving account address derivation:
...
This is a fundamental building block [keyless accounts](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-061-keyless-accounts.md) infrastructure.
...
For the full glossaries, see [keyless account specification](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-061-keyless-accounts.md#specification).
...
The same function needs to be implemented as [part of the ZK relation](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-061-keyless-accounts.md#snark-friendly-hash-functions),
...
as required by [AIP-61](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-061-keyless-accounts.md#peppers).
...
- Optionally:
  ...
  - derive byte string `id_commitment` from `(derived_pepper, jwt.payload.aud, uid_key, uid_val)`
    per [AIP-61](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-061-keyless-accounts.md#public-keys);
...
Testing should be done as part of end-to-end testing of [keyless accounts](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-061-keyless-accounts.md).
