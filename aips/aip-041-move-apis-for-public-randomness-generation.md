...
The proposed `randomness` module leverages an underlying _on-chain cryptographic randomness implementation_ run by the Aptos validators. This implementation, however, is **outside the scope** of this AIP and will be the focus of [a different AIP](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-079-implementation-of-instant-on-chain-randomness.md). 
...
- [v1.0](https://github.com/aptos-foundation/AIPs/blob/4577f34c8df6c52a213223cd62472ea59e3861ef/aips/aip-041-move-apis-for-public-randomness-generation.md)
  - Initial version of the `randomness` API
- [v1.1](https://github.com/aptos-foundation/AIPs/blob/3e40b4e630eb8aa517b617799f8e578f5f937682/aips/aip-041-move-apis-for-public-randomness-generation.md), 
...
- [v1.2](https://github.com/aptos-foundation/AIPs/blob/a7b84191fb27e9f897e311323479851963f49504/aips/aip-041-move-apis-for-public-randomness-generation.md):
