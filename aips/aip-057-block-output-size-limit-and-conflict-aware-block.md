...
This builds on top of [AIP-33](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-033-block-gas-limit.md), to improve latency predictability during arbitrary workload.
It includes:
