...
3. Improve Multisig Simulation Consistency:
   ...
   * This resolves the issue of an onchain payload not being retrived (desribed [here](https://github.com/aptos-labs/aptos-core/issues/12703)).
...
The implementation is planned to land on the `main` branch before the branch cut for v1.16.
...
* On the devnet: with release v1.16
