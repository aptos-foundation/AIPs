...
This AIP proposes a standard for Fungible Assets (FA) using [Move Objects](/aips/aip-010-move-objects.md). In this model, any on-chain asset represented as an object can also be expressed as a fungible asset allowing for a single object to be represented by many distinct, yet interchangeable units of ownership.
