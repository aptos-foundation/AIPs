...
This is done using [derivable account abstraction (AIP-113)](https://github.com/aptos-foundation/AIPs/blob/main/aips/aip-113-derivable-account-abstraction.md).
